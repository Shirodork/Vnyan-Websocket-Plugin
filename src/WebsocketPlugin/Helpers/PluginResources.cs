namespace Loupedeck.WebsocketPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.WebsocketPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.WebsocketPlugin.Resources.Resource.txt`.
